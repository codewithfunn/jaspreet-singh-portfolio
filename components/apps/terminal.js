...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            PDPU: ["Sem-6"],
            books: ["The C Programming Language 2e.pdf", "Data Structures and Algorithms Made Easy : Second Edition: Data Structure and Algorithmic Puzzles.pdf",  "The_Magic_of_Thinking_Big.pdf"],
            skills: ["Front-end development", "React.js", "jQuery", "Flutter", "Express.js", "SQL", "Firebase"],
            projects: ["coddiez", "FlizzyCreation", "keeper_note_making_app", "Dresson", "yellowKarat"],
            interests: ["Software Engineering", "Deep Learning", "AI"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">jaspreet@Dell</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/jaspreet")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-jaspreet, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-jaspreet":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-jaspreet");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-jaspreet, todoist, trash, settings, sendmsg ]";
                }
                break;
